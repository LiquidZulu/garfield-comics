...
<html>
  ...
  <body>
    ...
    <center>
      <div class='desc'>
        This page contains documentation for the Garfield Comics API, thus far you can use this API to access the custom built SRoMG API and any future API's I make for this bot will be detailed here. <br/><br/>You can access a JSON discord embed for a specific SRoMG comic by going to https://garfield-comics.glitch.me/~SRoMG/[?date=XXXXX // ?comic=XXXXX // ?url=URL_OF_SRoMG] where you either pass in a date which can be a Javascript Date object or a string in the form YYYY-MM-DD or you can pass in \`comic\` which is the comic number ie 2812 which is the 2812th comic at: <a href='http://www.mezzacotta.net/garfield/?comic=2812'>http://www.mezzacotta.net/garfield/?comic=2812</a>. <br/><strong>If you don't wish to cut a query for SRoMG comic down to the number or the date you can pass in the url to the comic page ie http://www.mezzacotta.net/garfield/?comic=XXXX</strong>
      </div><br/><br/>
